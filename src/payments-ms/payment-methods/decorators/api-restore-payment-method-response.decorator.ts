...
import {
  ApiOperation, ApiResponse, ApiUnauthorizedResponse, ApiForbiddenResponse,
  ApiInternalServerErrorResponse, ApiHeader, ApiBearerAuth,
  ApiNotFoundResponse, ApiParam,
} from '@nestjs/swagger';

export const ApiRestorePaymentMethodResponse = () =>
  applyDecorators(
    ApiBearerAuth('jwt'),
    ApiParam({
      name: 'id',
    ...
    ApiNotFoundResponse({
      ...
      schema: { example: { message: 'Payment method not found', statusCode: 404 } },
    }),
    ...
    ApiForbiddenResponse({
      ...
      schema: { example: { message: 'You do not have access to this payment method', statusCode: 403, error: 'Forbidden' } },
    }),
