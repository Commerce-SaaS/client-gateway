...
export const ApiUpdatePaymentMethodResponse = <TModel extends Type<any>>(
  model: TModel,
) =>
  applyDecorators(
    ApiBearerAuth('jwt'),
    ...
    ApiBadRequestResponse({
      description: 'System payment methods cannot be deactivated',
      schema: {
        example: {
          message: 'System payment methods cannot be deactivated',
          statusCode: 400,
          error: 'Bad Request',
        },
      },
