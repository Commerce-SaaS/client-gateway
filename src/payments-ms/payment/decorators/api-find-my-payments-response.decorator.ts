...
const paginatedMyPaymentsSchema = {
  type: 'object',
  properties: {
    items: {
      type: 'array',
...
export const ApiFindMyPaymentsResponse = () =>
  applyDecorators(
    ApiBearerAuth('jwt'),
    ApiOperation({ summary: 'Get payments for the current authenticated customer' }),
    ApiHeader({
    ...
    ApiResponse({
      ...
      schema: paginatedMyPaymentsSchema,
    }),
    ApiBadRequestResponse({
