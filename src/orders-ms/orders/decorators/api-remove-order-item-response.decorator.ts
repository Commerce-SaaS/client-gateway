...
export const ApiRemoveOrderItemResponse = () =>
  applyDecorators(
    ApiBearerAuth('jwt'),
    ...
    ApiOperation({ summary: 'Remove a single item from an existing order' }),

    ApiResponse({
      status: 200,
      description: 'Item removed — returns the updated order',
